...
try {
    ...
    var queryDeResumo = ' SELECT ' +
        ...
        '   AND (MC.VRFISICODINHEIRO = 0 AND MC.VRRECDINHEIRO = 0 AND MC.VRRECTEF = 0 AND MC.VRRECPOS = 0 AND MC.VRRECVOUCHER = 0 AND MC.VRRECFATURA = 0 AND MC.VRRECCONVENIO = 0 AND MC.VRRECPIX = 0)';
