...
function excutePagamentoNaoIntegrado(byId, dataInicioVenda = '01.01.2025', dataFimVenda = '31.08.2025') {
    let query = ` 
        SELECT TOP 150
            TBV.IDVENDA, 
	...
	for (let i = 0; i < resultadoVenda.length; i++) {
        ...
        let stIntegrarPgto = validarIntegracao(registro.IDVENDA, false) == 'False'
        ...
        if(stIntegrarPgto){
            ...
            //return {jsonPagamento};
            postSl(jsonPagamento, registro.IDVENDA);
        }
