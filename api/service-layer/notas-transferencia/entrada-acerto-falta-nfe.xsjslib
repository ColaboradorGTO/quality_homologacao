...
function entradaAcertoFaltaNfe(idResumoOt,sessionSl) {
	...
	for (var i = 0; i < response.length; i++) {
		...
		var retCardCode = api.sqlQuery('select "U_IS_PN_ENTRADA" from "SBO_GTO_TESTE1".OBPL WHERE "BPLId" = ?',det.IDEMPRESADESTINO); 
