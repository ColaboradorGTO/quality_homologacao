...
function fnMovimentaInventario(lstDetProd, idResumoEntrada, conn) {
    ...
    slApi.executeEntradaNfe(idResumoEntrada);
}

function fnVincularNotaAoPedido(idResumoPedido, idResumoEntrada, lstDetProd, conn) {
    ...
    fnVinculaQtdPedidoQtdNFE(lstDetProd, conn);
}
...
function fnHandlePost() {
    var conn = $.db.getConnection();
    return slApi.executeEntradaNfe(28);
