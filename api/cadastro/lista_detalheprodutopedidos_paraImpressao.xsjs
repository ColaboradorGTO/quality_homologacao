...
function fnHandleGet(byId) {
    ...
    var query =  ' SELECT ' +
        ...
        '   tbdpp.NUNCM,' +
        '   tbdpp.DSTAMANHO, ' +
        '   tbdpp.IDPRODCADASTRO AS IDPRODUTO, ' +
        ...
        '   (CASE ' +
        '        WHEN TBPEM.MARCA IS NULL THEN FR.NORAZAOSOCIAL ' +
        '        ELSE TBPEM.MARCA ' +
        '        END) AS MARCA ' +
        ' FROM ' +
        ...
        '   INNER JOIN "VAR_DB_NAME".PRODUTO TBP ON tbdpp.IDPRODCADASTRO = TBP.IDPRODUTO  ' +
        '   LEFT JOIN "VAR_DB_NAME".VW_PRODUTO_ESTRUTURA_MERCADOLOGICA TBPEM ON TBPEM.IDPRODUTO = TBP.IDPRODUTO  ' +
        ' WHERE ' +
        '	1 = ?'+
